...
// Name:        subset.cpp
// Author:      Blake Madden
// Copyright:   © 2005-2022 Blake Madden
                ...
                if (m_comparisonType == Comparison::Equals ||
                    ...
                    if (const auto IdVal{ std::get_if<GroupIdType>(&value) };
                        ...
                        if (code.has_value())
                            ...
                            {
                            throw std::runtime_error(
                                wxString::Format(L"'%s': string value not found for "
        ...
        if (m_columnType == ColumnType::Categorical)
            ...
            for (const auto& str : m_stringValues)
                ...
                if (m_comparisonType == Comparison::Equals ?
                    ...
                    cmpResult >= 0)
                    {
                    wxLogMessage(_(L"GreaterThanOrEqualTo"));
                    return true;
                    }
                }
            }
    ...
    std::shared_ptr<Dataset> Subset::SubsetSimple(
        ...
        while (HasMoreRows())
            ...
            // shouldn't happen
                ...
                {
                wxLogWarning(_("HasMoreRows() unexpected branch entered?!"));
                break;
                }
            }
