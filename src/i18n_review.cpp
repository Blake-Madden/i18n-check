...
namespace i18n_check
    ...
    std::set<string_util::case_insensitive_wstring> i18n_review::m_file_extensions = { // NOLINT
        ...
        L"msi", L"rc", L"vcxproj", L"resx", L"appx",
        // macOS
    ...
    i18n_review::i18n_review()
        ...
        m_deprecated_string_functions = {
            ...
            { L"__targv", L"Use __wargv instead" },
            { L"__tcserror", L"Use __wcserror instead" },
            { L"__tcserror_s", L"Use __wcserror_s instead" },
            { L"_tcscat", L"Use std::wcscat instead" },
            { L"_tcscat_s", L"Use wcscat_s instead" },
            { L"_tcschr", L"Use std::wcschr instead" },
            { L"_tcsclen", L"Use std::wcslen instead" },
            { L"_tcscmp", L"Use std::wcscmp instead" },
            { L"_tcscnlen", L"Use std::wcsnlen instead" },
            { L"_tcscoll", L"Use std::wcscoll instead" },
            { L"_tcscoll_l", L"Use _wcscoll_l instead" },
            { L"_tcscpy", L"Use std::wcscpy instead" },
            { L"_tcscpy_s", L"Use wcscpy_s instead" },
            { L"_tcscspn", L"Use std::wcscspn instead" },
            { L"_tcsdup", L"Use _wcsdup instead" },
            { L"_tcserror", L"Use _wcserror instead" },
            { L"_tcserror_s", L"Use _wcserror_s instead" },
            { L"_tcsicmp", L"Use _wcsicmp instead" },
            { L"_tcsicmp_l", L"Use _wcsicmp_l instead" },
            { L"_tcsicoll", L"Use _wcsicoll instead" },
            { L"_tcsicoll_l", L"Use _wcsicoll_l instead" },
            { L"_tcslen", L"Use std::wcslen instead" },
            { L"_tcsncat", L"Use std::wcsncat instead" },
            { L"_tcsncat_l", L"Use _wcsncat_l instead" },
            { L"_tcsncat_s", L"Use std::wcsncat_s instead" },
            { L"_tcsncat_s_l", L"Use _wcsncat_s_l instead" },
            { L"_tcsnccmp", L"Use std::wcsncmp instead" },
            { L"_tcsnccoll", L"Use _wcsncoll instead" },
            { L"_tcsnccoll_l", L"Use _wcsncoll_l instead" },
            { L"_tcsncicmp", L"Use _wcsnicmp instead" },
            { L"_tcsncicmp_l", L"Use _wcsnicmp_l instead" },
            { L"_tcsncicoll", L"Use _wcsnicoll instead" },
            { L"_tcsncicoll_l", L"Use _wcsnicoll_l instead" },
            { L"_tcsncmp", L"Use std::wcsncmp instead" },
            { L"_tcsncoll", L"Use _wcsncoll instead" },
            { L"_tcsncoll_l", L"Use _wcsncoll_l instead" },
            { L"_tcsncpy", L"Use std::wcsncpy instead" },
            { L"_tcsncpy_l", L"Use _wcsncpy_l instead" },
            { L"_tcsncpy_s", L"Use wcsncpy_s instead" },
            { L"_tcsncpy_s_l", L"Use _wcsncpy_s_l instead" },
            { L"_tcsnicmp", L"Use _wcsnicmp instead" },
            { L"_tcsnicmp_l", L"Use _wcsnicmp_l instead" },
            { L"_tcsnicoll", L"Use _wcsnicoll instead" },
            { L"_tcsnicoll_l", L"Use _wcsnicoll_l instead" },
            { L"_tcsnlen", L"Use std::wcsnlen instead" },
            { L"_tcsnset", L"Use _wcsnset instead" },
            { L"_tcsnset_l", L"Use _wcsnset_l instead" },
            { L"_tcsnset_s", L"Use _wcsnset_s instead" },
            { L"_tcsnset_s_l", L"Use _wcsnset_s_l instead" },
            { L"_tcspbrk", L"Use std::wcspbrk instead" },
            { L"_tcsrchr", L"Use std::wcsrchr instead" },
            { L"_tcsrev", L"Use _wcsrev instead" },
            { L"_tcsset", L"Use _wcsset instead" },
            { L"_tcsset_l", L"Use _wcsset_l instead" },
            { L"_tcsset_s", L"Use _wcsset_s instead" },
            { L"_tcsset_s_l", L"Use _wcsset_s_l instead" },
            { L"_tcsspn", L"Use std::wcsspn instead" },
            { L"_tcsstr", L"Use std::wcsstr instead" },
            { L"_tcstod", L"Use std::wcstod instead" },
            { L"_tcstof", L"Use std::wcstof instead" },
            { L"_tcstoimax", L"Use std::wcstoimax instead" },
            { L"_tcstok", L"Use _wcstok instead" },
            { L"_tcstok_l", L"Use _wcstok_l instead" },
            { L"_tcstok_s", L"Use wcstok_s instead" },
            { L"_tcstok_s_l", L"Use _wcstok_s_l instead" },
            { L"_tcstol", L"Use std::wcstol instead" },
            { L"_tcstold", L"Use std::wcstold instead" },
            { L"_tcstoll", L"Use std::wcstoll instead" },
            { L"_tcstoul", L"Use std::wcstoul instead" },
            { L"_tcstoull", L"Use std::wcstoull instead" },
            { L"_tcstoumax", L"Use std::wcstoumax instead" },
            { L"_tcsxfrm", L"Use std::wcsxfrm instead" },
            { L"_tenviron", L"Use _wenviron instead" },
            { L"_tmain", L"Use wmain instead" },
            { L"_tprintf", L"Use wprintf instead" },
            { L"_tprintf_l", L"Use _wprintf_l instead" },
            { L"_tprintf_s", L"Use wprintf_s instead" },
            { L"_tWinMain", L"Use wWinMain instead" },
            { L"wsprintf", L"Use std::swprintf() instead." },
            { L"_stprintf", L"Use std::swprintf() instead." },
            { L"TCHAR", L"Use wchar_t instead." },
            { L"PTCHAR", L"Use wchar_t* instead." },
