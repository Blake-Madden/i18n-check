      ...
      protected:
        ...
        /** @brief Sets the length of the parsed text.
            @note Any text added before this call will still be there,
                ...
                Any subsequent calls to add_*() will overwrite any older text beyond this new
           length.\n This function should only be called when needing to overwrite previously parsed
           text.
