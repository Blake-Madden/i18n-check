...
i18n-check wxWidgets/src -i expat,zlib --enable=suspectL10NString -o results.txt
```
...
``` {.bash filename="Terminal"}
i18n-check src --ignore=easyexif,base/colors.cpp,base/colors.h -o results.txt
```
