...
For example, setting this to `17` or higher will issue warnings for `WXUNUSED`, as it
can be replaced with `[[maybe_unused]]`. If setting this to `14`, however, `WXUNUSED`
will be ignore since `[[maybe_unused]]` requires C++17.
