...
**Check for inconsistent printf format specifiers**: select this to check for mismatching `printf()` and positional commands between source and translation strings.
...
The default is 40, as "German and Spanish translations can sometimes take 40% more screen space than English" [@boyero:2020].
