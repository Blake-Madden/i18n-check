...
To mark a string as translatable, select the string in the editor and select **Mark Selection for Translation...** from the `r keys("Insert")` button.
From the **Mark Selection for Translation** dialog, options are available for choosing which translation function to use, along with providing a domain or context (if applicable).
...
To mark a string as non-translatable, select the string in the editor and select **Mark Selection as Non-translatable...** from the `r keys("Insert")` button.
